...
(async function() {
  ...
  try {
    ...
    if (globalThis.WhitelistUtils && WhitelistUtils.isWhitelisted(location.host, wl)) {
      return; // Whitelisted, skip tracker blocking
    }
  } catch (e) {
    // In case of error, proceed with protection as a safeguard
  }
